...
<div class="h-[480px] w-[360px] bg-white rounded-lg flex flex-col items-center justify-end">
    <div class="relative w-full h-full rounded-tl-lg rounded-tr-lg">
        <div class="absolute inset-0 bg-gradient-to-r {{ $data['current']['temperature'] <= 15 ? 'from-[#CAECFF00] to-[#78CFFF]' : 'from-[#FFF4CA00] to-[#FFDD78]' }} rounded-tl-lg rounded-tr-lg opacity-75"></div>
        <div class="bg-{{rand(1,3)}} bg-cover bg-center bg-no-repeat w-full h-full rounded-tl-lg rounded-tr-lg p-10">
    ...
    <div class="flex flex-row justify-between items-center pr-5 pl-5 pb-10 pt-10 gap-x-2">
        <div>
