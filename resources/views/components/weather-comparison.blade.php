...
<div class="flex flex-row gap-x-10">
    <div class="bg-white rounded-lg flex flex-col gap-y-5 h-[480px] pl-10 pr-10 justify-center max-w-[500px]"> 
        ...
        <div class="flex flex-col gap-y-0 text-[#5E5E5E]">
            <h2 class="font-bold text-4xl">{{ $temperatureComparison }}°</h2>
